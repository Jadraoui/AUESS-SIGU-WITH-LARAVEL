  ...
  <div class="container box" style="width:1100px; margin-left:-2%;">
    <nav style="position:absolute;margin-top:1%;width:100%;">
        ...
        <ul class="ul" style="width:252px; margin-left:35%;">
            <li><a href="{{url('commission')}}">Tous</a></li>
            <li ><a href="{{url('commission/0/traite')}}">Traités</a></li>
            <li style="background-color:#5bc0de;text-aligne:center;"><a href="{{url('commission/0/non_traite')}}">Non traités</a></li>
   ...
   @if($projet->type=='')
      ...
      <tr style="text-align:center;">
        ...
        @can('adminOragent_guOrarchi')
        <td><a href="{{url('commission/'.$projet->id.'/createtraite')}}">
            <button type="submit" class="table-add glyphicon glyphicon-plus"  style="color:blue;"></button></a></td>
@endcan
