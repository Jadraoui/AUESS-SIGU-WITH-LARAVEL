  ...
  <div class="container box" style="width:1100px; margin-left:-2%;">
    <nav style="position:absolute;margin-top:1%;width:100%;">
        ...
        <ul class="ul" style="width:252px; margin-left:35%;">
            ...
            <li style="background-color:#5bc0de;text-aligne:center;"><a href="{{url('commission/0/traite')}}">Traités</a></li>
      ...
      <table class="table table-striped table-bordered">
          <thead>
              <tr>
               ...
               <th  style="text-align:center" width="10%">Date de commission</th>
