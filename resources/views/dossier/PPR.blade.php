  ...
  <div class="container box" style="width:1100px; margin-left:-2%;">
    <nav style="position:absolute;margin-top:1%;width:100%;">
                ...
                <ul class="ul">
                    ...
                    <li  style="background-color:#5bc0de;text-aligne:center;"><a href="{{url('dossier/PPR')}}">PPR</a></li>
    ...
    <div class="panel-heading">
     ...
     <div class="container">
        ...
        <div class="row pull-right" style="margin-right: 10%;">
                <a href="{{ route('view-pdf-ppr') }}" type="button" class="btn btn-info">Telecharger PDF</a>
                <a href="{{ url('downloadExcelSearchPPR/xlsx') }}"><button class="btn btn-info">Exporter</button></a>
        </div>
        <form action="/casesPPR" method="GET">
        ...
        <div style="float:right">
            <form action="{{ url('importExcelPPR') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                @csrf
     ...
     <div class="table-responsive">
      <table class="table table-striped table-bordered">
          <thead>
              ...
              @can('adminOragent_gu')
              <th  style="text-align:center" width="4%"><a href="{{ url('dossier/createPPR') }}">
   ...
   @foreach($projets as $projet)
      <tr style="text-align:center;">
          ...
          {{--<td>{{$projet->date_pro}}</td>--}}
         <td>@can('adminOragent_gu')
           <a href="{{url('historique/'.$projet->id.'/captPPR')}}">
        ...
        <td>
          ...
          <a href="{{url('commission/'.$projet->id.'/createPPR')}}">
         <button type="submit" class="table-add glyphicon glyphicon-plus" style="color:blue;"></button></a>&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;
         @else
         {{$projet->type}}
     ...
     @endif
        ...
        <td>    <a href=" {{url('dossier/'.$projet->id.'/details')}} "> <button type="submit" class="glyphicon glyphicon-info-sign" style="color:blue;"></button>
          ...
          @can('adminOragent_gu')
              <a href=" {{url('dossier/'.$projet->id.'/editPPR')}} "> <button type="submit" class="glyphicon glyphicon-pencil" style="color:blue;"></button>
            </a>&nbsp;
