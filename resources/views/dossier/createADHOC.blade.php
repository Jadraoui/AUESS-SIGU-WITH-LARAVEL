...
@section('content')
	...
	<div class="container-contact100" style="background-image: url('images/bg-01.jpg');">
		...
		<form action="{{url('dossier/storeADHOC')}}" method="post" class="contact100-form validate-form" >
				@Csrf
				<span class="contact100-form-title" style="text-align: center;">
					Fiche d'analyse : AD-HOC
				</span>
        ...
        <input class="input100" type="text" name="num" placeholder="Entrer le numéro.." required=""
         oninput="this.value = this.value.replace(/[^0-9./]/g, '').replace(/(\..*)\./g, '$1');">
					...
					<input class="input100" type="text" name="adre" placeholder="Entrer l'adresse">
				</div>


				<div class="wrap-input100" >
									<span class="label-input100">Numéro du titre foncier</span>
            <input class="input100" type="text" name="numt" placeholder="Entrer le numéro du titre foncier"
            oninput="this.value = this.value.replace(/[^0-9./]/g, '').replace(/(\..*)\./g, '$1');">
								</div>
