  ...
  <div class="container box" style="width:1100px; margin-left:-2%;">
    <nav style="position:absolute;margin-top:1%;width:100%;">
                ...
                <ul class="ul">
                    ...
                    <li style="background-color:#5bc0de;text-aligne:center;"><a href="{{url('dossier/derogation')}}">Dérogation</a></li>
                  </ul>
        </nav><br><br>
   <h3></h3><br />
    ...
    <div class="panel-heading">
     ...
     <div class="container">
        ...
        <div class="row pull-right" style="margin-right: 10%;">
            <a href="{{ route('view-pdf-Derogation') }}" type="button" class="btn btn-info">Telecharger PDF</a>
            <a href="{{ url('downloadExcelSearchDerogation/xlsx') }}"><button class="btn btn-info">Exporter</button></a>
        </div>
        <form action="/casesDerogation" method="GET">
        ...
        <div style="float:right">
            <form action="{{ url('importExcelDERO') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                @csrf
     ...
     <div class="table-responsive">
      <table class="table table-striped table-bordered">
          <thead>
              ...
              @can('adminOragent_gu')
              <th  style="text-align:center" width="4%"><a href="{{ url('dossier/createDEROGATION') }}">
   ...
   <tr style="text-align:center;">
    <td>{{ $projet->num }}</td>
        ...
        <td>  @can('adminOragent_gu')<a href="{{url('historique/'.$projet->id.'/captDEROGATION')}}">
       ...
       <td>
          ...
          <a href="{{url('commission/'.$projet->id.'/createDERO')}}">
         <button type="submit" class="table-add glyphicon glyphicon-plus" style="color:blue;"></button></a>&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;
         @else
         {{$projet->type}}
         @endif </td>
        ...
        <td>     <a href=" {{url('dossier/'.$projet->id.'/details')}} "> <button type="submit" class="glyphicon glyphicon-info-sign" style="color:blue;"></button>
            ...
            @can('adminOragent_gu')
              <a href=" {{url('dossier/'.$projet->id.'/editDER')}} "> <button type="submit" class="glyphicon glyphicon-pencil" style="color:blue;"></button>
              </a>&nbsp;
        ...
        <td>
                ...
                @endif
                @if($projet->val_auto=='1' || $projet->val_auto=='0'  && $projet->val_auto=='1' &&($projet->val=='1'))
                <td>
                    @if($projet->pay=='0')
                    @can('adminOrregi')
