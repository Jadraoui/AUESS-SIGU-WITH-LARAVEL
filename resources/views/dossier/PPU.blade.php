  ...
  <div class="container box" style="width:1100px; margin-left:-2%;">
    <nav style="position:absolute;margin-top:1%;width:100%;">
                <ul class="ul">
                    ...
                    <li  style="background-color:#5bc0de;text-aligne:center;"><a href="{{url('dossier/PPU')}}">PPU</a></li>
    ...
    <div class="panel-heading">
     ...
     <div class="container">
        ...
        <div class="row pull-right" style="margin-right: 10%;">
            <a href="{{ route('view-pdf-ppu') }}" type="button" class="btn btn-info">Telecharger PDF</a>
            <a href="{{ url('downloadExcelSearchPPU/xlsx') }}"><button class="btn btn-info">Exporter</button></a>
        </div>
        <form action="/casesPPU" method="GET">
     ...
     <div class="table-responsive">
      ...
      <table class="table table-striped table-bordered">
          <thead>
              ...
              @can('adminOragent_gu')
              <th  style="text-align:center" width="4%"><a href="{{ url('dossier/createPPU') }}">
      ...
      <tr style="text-align:center;">
        <td>{{ $projet->num}}</td>
         ...
         <td>@can('adminOragent_gu')
           <a href="{{url('historique/'.$projet->id.'/captPPU')}}">
...
@can('adminOragent_gu')
      <td>
          @if($projet->type=='')
          <a href="{{url('commission/'.$projet->id.'/createPPU')}}">
         <button type="submit" class="table-add glyphicon glyphicon-plus" style="color:blue;"></button></a>&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;
         @else
         {{$projet->type}}
         @endif
  ...
  @can('adminOragent_gu')
               <a href=" {{url('dossier/'.$projet->id.'/editPPU')}} "> <button type="submit" class="glyphicon glyphicon-pencil" style="color:blue;"></button>
            </a>&nbsp;
        ...
        <td>
          @if(3*($projet->SurfaceTaxe)+(0.2*(3*($projet->SurfaceTaxe)))>5000 && $projet->val_auto=='0' &&($projet->val=='1'))
          ...
          @elseif(3*($projet->SurfaceTaxe)+(0.2*(3*($projet->SurfaceTaxe)))>5000 && $projet->val_auto=='1' &&($projet->val=='1'))
