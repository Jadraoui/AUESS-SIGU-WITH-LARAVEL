...
@section('content')
	...
	<div class="container-contact100" style="background-image: url('images/bg-01.jpg');">
		...
		<form action="{{url('dossier')}}" method="post" class="contact100-form validate-form" >
				@Csrf
...
<div class="wrap-input100" >
										<span class="label-input100">Type de projet *</span>
										<select class="input100" style="width:100%;height:50px;" name="type">
												@foreach($types as $type)
												<option value="{{$type->id}} ">{{$type->intitule_type}}</option>
													@endforeach
										</select>
									</div>
			...
			<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate=" required">
				...
				<div class="wrap-input100" >
						...
						<input class="input100" type="text" name="adre" placeholder="Entrer l'adresse du projet">
					</div>
...
<div class="wrap-input100" >
				...
				<div class="wrap-input100 validate-input" >
					...
					<div class="wrap-input100" >
                            ...
                            <input class="input100" type="text" name="numt" placeholder="Entrer le numéro du titre foncier du projet"
                            oninput="this.value = this.value.replace(/[^0-9./]/g, '').replace(/(\..*)\./g, '$1');">
						</div>

						<div class="wrap-input100 rs1-wrap-input100 validate-input">
								<span class="label-input100">Superficie</span>
								<input class="input100" type="text" name="supe" placeholder="Entrer la superficie">
							</div>

							<div class="wrap-input100 rs1-wrap-input100 validate-input" >
								<span class="label-input100">Hauteur</span>
								<input class="input100" type="text" name="haut" placeholder="Entrer la Hauteur">
							</div>

							<div class="wrap-input100 rs1-wrap-input100 validate-input">
									<span class="label-input100">C.E.S</span>
									<input class="input100" type="text" name="ces" placeholder="C.E.S....">
								</div>

								<div class="wrap-input100 rs1-wrap-input100 validate-input" >
									<span class="label-input100">C.O.S</span>
									<input class="input100" type="text" name="cos" placeholder="C.O.S....">
								</div>
              ...
              <a href="{{ url('dossier')}}" class='btn btn-primary'>Annuler</a>
              <button type="submit"
