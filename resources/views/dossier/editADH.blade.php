...
@section('link')
	...
	<div class="container-contact100" style="background-image: url('images/bg-01.jpg');">
		...
		<form action="{{url('dossier/'.$projet->id.'/ADH')}}" method="post" class="contact100-form validate-form" >
			<input type="hidden" name="_method" value="PUT">

				@Csrf
				<span class="contact100-form-title" style="text-align: center; ">
				Modifier la fiche d'analyse: Ad-Hoc
				</span>
				<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate=" required">
						...
						<input class="input100" type="text"  style="border:1px #3c8dbc solid;" name="num" value="{{$projet->num}}">
					</div>
